package Graphics::Penplotter::GcodeXY::Swirl v0.1.0;
...
Given a base polygon with vertices V[0] … V[n-1] and per-edge advance
fractions f[0] … f[n-1] (converted from the supplied percentages):
